...
import 'package:flutterappdatabase/ui/daftar_tambah.dart';
import 'package:flutterappdatabase/models/mpanitia.dart';
import 'package:flutterappdatabase/helpers/helper_database.dart';
...
class HomeState extends State<Home> {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () async {
          ...
          if (panitia != null) addContact(panitia);
        },
      ),
    );
  }
      ...
      itemBuilder: (BuildContext context, int index) {
        return Card(
          ...
          child: ListTile(
            ...
            subtitle: Text(this.panitiaList[index].jurusan + ' | Panitia ' + this.panitiaList[index].panitia),
  ...
  void addContact(Panitia object) async {
  ...
  //edit contact
  void editContact(Panitia object) async {
